...
public class BusRouteServiceJava8Test {
    ...
    public void directRouteExists() {
        boolean directRoute = busRouteService.directRouteJava8(busRoutes,3,6, true);
        assertThat(directRoute).isTrue();
    }

    @Test
    public void directRouteBiDirectionExists() {
        boolean directRoute = busRouteService.directRouteJava8(busRoutes,6,3, true);
        assertThat(directRoute).isTrue();
    }

    @Test
    public void directRouteNotExists() {
        boolean directRoute = busRouteService.directRouteJava8(busRoutes,5,2, true);
        assertThat(directRoute).isFalse();
    }

    @Test
    public void directRouteUniDirectionNotExists() {
        boolean directRoute = busRouteService.directRouteJava8(busRoutes,6,3, false);
        assertThat(directRoute).isFalse();
    }
}
